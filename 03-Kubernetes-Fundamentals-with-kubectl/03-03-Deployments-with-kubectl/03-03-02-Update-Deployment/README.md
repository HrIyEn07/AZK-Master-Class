...
kubectl set image deployment/my-first-deployment kubenginx=hriyen/kubenginx:2.0.0 --record=true
```
...
# Change From 2.0.0
    spec:
      containers:
      - image: hriyen777/kubenginx:2.0.0

# Change To 3.0.0
    spec:
      containers:
      - image: hriyen777/kubenginx:3.0.0
```
