...
- **Docker Image Location:** https://hub.docker.com/repository/docker/hriyen777/acr-myindia-app/general
```
# Create Deployment
kubectl create deployment <Deplyment-Name> --image=<Container-Image>
kubectl create deployment my-first-deployment --image=hriyen777/acr-myindia-app:v1 
